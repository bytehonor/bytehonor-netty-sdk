...
//        this.whoiam = "unkwon";
        ...
        this.maxFrameLength = NettyConstants.MAX_FRAME_LENGTH;
        this.lengthFieldOffset = NettyConstants.LENGTH_FIELD_OFFSET;
        this.lengthFieldLength = NettyConstants.LENGTH_FIELD_LENGTH;
