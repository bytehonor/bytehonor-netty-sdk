 ...
 * @param <T>
 */
public abstract class AbstractNettyConsumerThread<T> implements NettyConsumer {

    private static final Logger LOG = LoggerFactory.getLogger(AbstractNettyConsumerThread.class);
    ...
    public AbstractNettyConsumerThread() {
        this(4096);
    }

    public AbstractNettyConsumerThread(int queues) {
